        ...
        <div class="slide-1__back">
          <div class="slide-1__img" style="background-image: url(<?bloginfo('template_url');?>/img/img1-min.png)">
            <div class="slide-1__wrap">
              <div class="slide-1__title">
                <h1 class="show">Снимите напряжение с глаз</h1>
                <h1>Снимите напряжение с глаз 2</h1>
                <h1>Снимите напряжение с глаз 3</h1>
                <h1>Снимите напряжение с глаз 4</h1>
                <h1>Снимите напряжение с глаз 5</h1>
